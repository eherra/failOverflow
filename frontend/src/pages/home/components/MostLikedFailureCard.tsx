...
import { Card, CardHeader, Heading, Box, Avatar, CardBody, NameValueList, NameValuePair, StarRating } from 'grommet';
    ...
    <Card margin='medium' pad='medium'>
      ...
      <CardBody>
        <NameValueList
          ...
          <NameValuePair name='Title'>{dayReview?.title}</NameValuePair>
